...
Shader "CameraFilterPack/Blur_Focus"
{
    Properties
    {
        ...
        SubShader
        {
            ...
            {
    float cc = coord - float2(0.5 + _CenterX / 2, 0.5 + _CenterY / 2); //_CenterY거의 센터는 캐릭터로 설정
            ...
            fixed4 frag(v2f i) : COLOR
            {
                ...
                {
        fixed4 a = tex2D(_MainTex, barrelDistortion(uv, u / _Circle)); //_Circle 캐릭터에게 줌을 땡기면서  주위 블러효과
                    tx += a;
                }
